    ...
    <NavigationPage title="Home">
      <div className="flex h-dvh w-full items-center justify-center">
        <div className="h-80 w-full">
          <Carousel slides={[<Welcome />, <Issues />]} />
        </div>
      </div>
    </NavigationPage>
  );
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-linear-to-br from-[#51d148] to-[#0ac8a8]">
      <div className="absolute inset-0 flex flex-col justify-center gap-2 p-14">
        ...
        <p className="max-w-xl text-xl drop-shadow-md">
          This is the demo to show the components based on Adwaita.
        </p>
        <Button
          role="link"
          variant="suggested"
          onClick={() =>
            window.location.assign(
              "https://github.com/oscar370/adw-components-react",
            )
          }
        >
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-linear-to-br from-[#d1476a] to-[#c70a34]">
      <div className="absolute inset-0 flex flex-col justify-center gap-2 p-14">
        ...
        <p className="max-w-xl text-xl drop-shadow-md">
          Report errors or leave your suggestions in the Issues section on
          GitHub.
        </p>
        <Button
          role="link"
          ...
          onClick={() =>
            window.location.assign(
              "https://github.com/oscar370/adw-components-react/issues",
            )
          }
        >
          <span className="size-4">
